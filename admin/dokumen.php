	...
	if($_POST['upload']){
        ...
        if(in_array($ekstensi, $ekstensi_diperbolehkan) === true){
            if($ukuran < 5044070){ 
				...
				$_SESSION['msg']="FILE BERHASIL DI UPLOAD!";
                }
                else{
					$_SESSION['msg']="FILE GAGAL DI UPLOAD!";
                }
            }
            else{
...
//$sql=mysqli_query($con,"insert into dokumen(nama,dok) values('$nama','$file')");
//$_SESSION['msg']="Dokumen berhasil di tambahkan !!";

//Code Deletion
if(isset($_GET['del']))
{
$sid=$_GET['id'];	
mysqli_query($con,"delete from dokumen where id = '$sid'");
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin | Add Dokumen</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin</span>
							...
							<div class="row">
										...
										<div class="col-lg-6 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title center">Tambah Dokumen</h5>
												</div>
								...
								<div class="col-md-12">
									...
									<table class="table table-hover" id="sample-table-1">
										...
										<tbody>
												<?php
												$sql=mysqli_query($con,"select * from dokumen");
												$cnt=1;
											...
											<tr>
												...
												<td class="hidden-xs"><a href="/kjkn/<?php echo $row['dok'];?>">Lihat</a></td>
												</td>
						...
						<!--	<a href="edit-jadwal.php?id=<?php echo $row['id'];?>" class="btn btn-transparent btn-xs" tooltip-placement="top" tooltip="Edit"><i class="fa fa-pencil"></i></a>
												-->					
	<a href="dokumen.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')"class="btn btn-transparent btn-xs tooltips" tooltip-placement="top" tooltip="Remove"><i class="fa fa-times fa fa-white"></i></a>
												</div>
