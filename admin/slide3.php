...
if($nama==""){
	$query=mysqli_query($con,"update banner set PageTitle='$pagetitle',PageDescription='$pagedes' where  PageType='slide3'");
	...
	if($ukuran < 5044070){ 
     ...
     $query=mysqli_query($con,"update banner set PageTitle='$pagetitle',PageDescription='$pagedes', PageDescription2='$nama'  where  PageType='slide3'");
    if ($query) {
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin  | Update Slide 3 Content</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin </span>
...
$ret=mysqli_query($con,"select * from  banner where PageType='slide3'");
$cnt=1;
