...
if($nama==""){
	$query=mysqli_query($con,"update banner set PageTitle='$pagetitle',PageDescription='$pagedes' where  PageType='slide2'");
	echo '<script>alert("slide Kami has been updated.")</script>';
}else if(in_array($ekstensi, $ekstensi_diperbolehkan) === true){
	if($ukuran < 5044070){ 
		move_uploaded_file($file_tmp, 'aset/slide/'.$nama);
     $query=mysqli_query($con,"update banner set PageTitle='$pagetitle',PageDescription='$pagedes', PageDescription2='$nama'  where  PageType='slide2'");
    if ($query) {
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin  | Update Slide 2 Content</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin </span>
...
$ret=mysqli_query($con,"select * from  banner where PageType='slide2'");
$cnt=1;
...
?>
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" name="pagedes"  rows="12"><?php  echo $row['PageDescription'];?></textarea>
                    </div>
					<div class="form-group">	
