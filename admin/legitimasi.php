				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin  | Update Legalitas</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin </span>
...
?>
                    ...
                    <div class="form-group">
					  ...
					  <textarea class="form-control" name="kantor" id="kantor" ><?php  echo $row['kantor'];?></textarea>
